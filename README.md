...
Further details on each dataset are documented in [raw.md](data/raw.md), and the final merged dataset is documented in [processed](data/processed.md) and saved as [usd_lkr_gold_cleaned.csv](data/usd_lkr_god_cleaned.csv). Which is contains 12,680 rows spanning 2 January 1975 to 16 April 2026, with eight columns: lkr_close, lkr_open, lkr_high, lkr_low, gold_open, gold_high, gold_low, and gold_close.
